...
Из описаных ранее условий удалим из доверенных _Manager_-а. Соотвественно каналы связи с ним также становятся не довереннымы. Выступая посредниками взаимодействия _Verifier_-а и _Updater_-а, и _Storage_, и _Manager_ имеют возможность реализовать [MITM-атаку](https://encyclopedia.kaspersky.ru/glossary/man-in-the-middle-attack/).
...
На мой взгляд, единственным вариантом решения задачи явлвяется применеие шифрования канала передачи данных.
